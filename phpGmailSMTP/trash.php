				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">          
					   <select class="form-control" id="location" name="location"required>
						   <option class="form-control" >karkala</option>
						   <option class="form-control" >nitte</option>
						   <option class="form-control" >mangaluru</option>
						   <option class="form-control" >katpadi</option>
						   <option class="form-control" >manipal</option>
					   </select>
					</div>
				  </div>
				<div class="form-group">
